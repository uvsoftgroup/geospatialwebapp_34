...
// set map view center
var centerCoordinate = [90.37126734852791,23.825515115835344];
// add OSM based Map
map = new ol.Map({
	target : 'map',
...
//add start Polygon2 into the Map


//add start Polygon3 into the Map
var coordinates3;
var featurePolygon3;
coordinates3 = [[[90.371287,23.825549],[90.371260,23.825672],[90.371376,23.825692],[90.371402,23.825567],[90.371287,23.825549]]];
...
var coordinates4;
var featurePolygon4;
coordinates4 = [[[90.371458,23.825569],[90.371432,23.825701],[90.371522,23.825716],[90.371548,23.825584],[90.371458,23.825569]]];
...
var coordinates5;
var featurePolygon5;
coordinates5 =[[[90.371559 ,23.825594],[90.371535 ,23.825720],[90.371584 ,23.825729],[90.371611 ,23.825602],[90.371559 ,23.825594]]];
...
var co6;
var featurePolygon6;
co6 = [[[90.371614,23.825612],[90.371594,23.825729],[90.371647,23.825735],[90.371666,23.825618],[90.371614,23.825612]]];
featurePolygon6 = new ol.Feature({
	geometry : new ol.geom.Polygon(co6)
...
var co7;
var featurePolygon7;
co7 = [[[90.371101,23.825305],[90.371079 ,23.825436],[90.371231,23.825460],[90.371255,23.825327],[90.371101,23.825305]]];

featurePolygon7 = new ol.Feature({
	geometry : new ol.geom.Polygon(co7)
...
var co8;
var featurePolygon8;
co8 = [[[90.371343,23.825347],[90.371323,23.825467],[90.371390,23.825478],[90.371411,23.825357],[90.371343,23.825347]]];

featurePolygon8 = new ol.Feature({
	geometry : new ol.geom.Polygon(co8)
...
var coordinates9;
var featurePolygon9;
coordinates9 = [[[90.371441,23.825363],[90.371420,23.825487],[90.371501,23.825498],[90.371522,23.825374],[90.371441,23.825363]]];
...
coordinates10 = [[[90.371618,23.825389],[90.371589,23.825519],[90.371661,23.825533],[90.371692,23.825401],[90.371618,23.825389]]];
...
var coordinates10;
var featurePolygon10;
co10 =[[[90.371618,23.825389],[90.371589,23.825519], [90.371661,23.825533],[90.371692,23.825401],[90.371618,23.825389]]];

featurePolygon10 = new ol.Feature({
	geometry : new ol.geom.Polygon(co10)
